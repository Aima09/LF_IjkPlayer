...
public class VideoPlayerActivity extends AppCompatActivity {
    @BindView(R.id.video_ijkplayer)
    StandardGSYVideoPlayer videoIjkplayer;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        videoIjkplayer.setUp(videoInfo.getPath(),true,videoInfo.getTitle());
        videoIjkplayer.startPlayLogic();
