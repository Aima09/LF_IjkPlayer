package com.linford.pldroidplayer;
...
import com.linford.pldroidplayer.widget.MediaController;
import com.pili.pldroid.player.AVOptions;
import com.pili.pldroid.player.PLMediaPlayer;
import com.pili.pldroid.player.widget.PLVideoTextureView;

public class VideoPalyerActivity3 extends AppCompatActivity  {

    private static final String TAG = VideoPalyerActivity3.class.getSimpleName();
   ...
   // private TextView mStatInfoTextView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_video_palyer3);
    ...
    private void showToastTips(final String tips) {
        runOnUiThread(new Runnable() {
            ...
            public void run() {
                ...
                mToast = Toast.makeText(VideoPalyerActivity3.this, tips, Toast.LENGTH_SHORT);
                mToast.show();
            }
        });
    }
