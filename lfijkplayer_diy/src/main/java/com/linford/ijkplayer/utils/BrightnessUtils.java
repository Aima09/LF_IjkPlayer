package com.linford.ijkplayer.utils;
...
/**
 * * Android调节屏幕亮度工具类
 * Created by LinFord on 2017/12/28 .
 */
...
public class BrightnessUtils {
    ...
    public static int getTotalBrightness(Context context) {
        int TotalBrightness = 0;
        try {
            TotalBrightness = Settings.System.getInt(context.getContentResolver(), Settings.System.SCREEN_BRIGHTNESS);
        } catch (Settings.SettingNotFoundException e) {
            e.printStackTrace();
        }
